...
extern "C"
{
	...
	void __stdcall UNativeStr_WithSuffix(ubotAppSetOnReceiveChatMessageAsyncHandler)(void* ctx, void* user, EventResultType(__stdcall* handler)(void* ctx, void* user, ubot::Encoding::ConstStr bot, ChatMessageType type, ubot::Encoding::ConstStr source, ubot::Encoding::ConstStr sender, ubot::Encoding::ConstStr message, ubot::Encoding::ConstStr info, void* async));
	...
	void __stdcall UNativeStr_WithSuffix(ubotAppSetOnMemberJoinedAsyncHandler)(void* ctx, void* user, EventResultType(__stdcall* handler)(void* ctx, void* user, ubot::Encoding::ConstStr bot, ubot::Encoding::ConstStr source, ubot::Encoding::ConstStr sender, ubot::Encoding::ConstStr inviter, void* async));
	...
	void __stdcall UNativeStr_WithSuffix(ubotAppSetOnMemberLeftAsyncHandler)(void* ctx, void* user, EventResultType(__stdcall* handler)(void* ctx, void* user, ubot::Encoding::ConstStr bot, ubot::Encoding::ConstStr source, ubot::Encoding::ConstStr sender, void* async));
	...
	void __stdcall UNativeStr_WithSuffix(ubotAppSetProcessGroupInvitationAsyncHandler)(void* ctx, void* user, EventResultType(__stdcall* handler)(void* ctx, void* user, ubot::Encoding::ConstStr bot, ubot::Encoding::ConstStr sender, ubot::Encoding::ConstStr target, ubot::Encoding::ConstStr reason, void* async));
	...
	void __stdcall UNativeStr_WithSuffix(ubotAppSetProcessFriendRequestAsyncHandler)(void* ctx, void* user, EventResultType(__stdcall* handler)(void* ctx, void* user, ubot::Encoding::ConstStr bot, ubot::Encoding::ConstStr sender, ubot::Encoding::ConstStr reason, void* async));
	...
	void __stdcall UNativeStr_WithSuffix(ubotAppHost)(void* ctx, ubot::Encoding::ConstStr op, ubot::Encoding::ConstStr urlStr, ubot::Encoding::ConstStr id, bool mtf);
